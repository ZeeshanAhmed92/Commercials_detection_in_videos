...
#         target_times = normalize_to_list(data.get("time")) or None  # ["0900","1000"]
...
#                     # ------------------------------------
#                     # CASE A: No time provided → all files
#                     # ------------------------------------
#                     if not target_times:
#                         tasks_to_run.append({
#                             "channel": ch,
#                             "date": dt,
#                             "time_sel": None,  # process full folder
#                             "base_path": BASE_PATH,
#                             "ads_language": lang
#                         })
