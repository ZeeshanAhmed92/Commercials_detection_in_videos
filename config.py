...
# FULL_SCORE_FLOOR   = 0.85        # minimum score to classify as "Full"
...
LOUDNORM_TP      = -1.5
LOUDNORM_LRA     = 11
MIN_WAV_BYTES    = 16_000
CONVERT_WORKERS_ADS   = 6
CONVERT_WORKERS_MIXED = 8
SUPPORTED_VIDEO_FORMATS = (
    ".mp4", ".mkv", ".avi", ".mov", ".flv", ".ts", ".mpeg"
)
...
FAN_VALUE        = 40
MAX_TIME_DELTA   = 400
HASH_TRUNCATE    = 20        # kept for legacy compatibility; no longer used in hashing
...
# Full / Partial classification
FULL_DUR_TOLERANCE = 0.5
FULL_SCORE_FLOOR   = 0.85

BULK_SQL_IN_CHUNK  = 5_000

# Refinement score gates (new)
# Detections at or above this score skip xcorr — coarse boundaries are tight enough
REFINE_SKIP_HIGH_SCORE = 0.95
# Detections below this score also skip xcorr — set to 0.0 to refine everything
REFINE_MIN_SCORE       = 0.0
...
HOP_TIME_SEC = HOP_LENGTH / SR_EXPECTED


# ═══════════════════════════════════════════════════════════════════════════════
#  S3 INTERNAL PARALLELISM
# ═══════════════════════════════════════════════════════════════════════════════

HASH_LOOKUP_CHUNKS  = 4
REFINE_WORKERS      = 4
HASH_GEN_WORKERS    = 4    # kept for API compatibility; vectorisation makes this unused
