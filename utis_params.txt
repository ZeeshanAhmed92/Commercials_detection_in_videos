...
# # =============================================================
# #   FULL PIPELINE (NO DB WRITES HERE)
# # =============================================================
...
# ):
#     """
#     Conversion + Detection only.
#     Fingerprint DB must already exist (built once globally).
#     """
...
#     print(f"\n=== Starting pipeline for {channel}/{date} ===")
#     final_path = os.path.join(base_path, channel)
...
#         specific_ads=specific_ads
#     )
#     print(f"[{channel}/{date}] Convert time: {time.time() - t0:.2f}s")

#     # -----------------------------
#     # 2. Detection (READ-ONLY DB)
#     # -----------------------------
#     t1 = time.time()
#     detected_segments = detect_ads(
#         language=ads_language,
...
#         specific_ads=specific_ads
#     )
#     print(f"[{channel}/{date}] Detect time: {time.time() - t1:.2f}s")

#     print(f"[{channel}/{date}] TOTAL: {time.time() - t0:.2f}s\n")
...
# # =============================================================
# #   MAIN ORCHESTRATOR (SAFE)
# # =============================================================
# def run_all_tasks_and_save_json(
#     tasks_to_run,
#     output_json_path="Outputs/ALL_DETECTED_ADS.json",
#     num_workers=None
# ):
#     """
#     SAFE PIPELINE:
#     1) Build fingerprint DB ONCE (single-threaded)
#     2) Run detection tasks in parallel (read-only DB)
...
#     print("\n" + "#" * 70)
#     print(f"🚀 Received {len(tasks_to_run)} tasks")
#     print("#" * 70)

#     # -----------------------------
#     # STEP 1: Build fingerprint DB ONCE
#     # -----------------------------
#     first_task = tasks_to_run[0]

#     print("\n🔒 Building fingerprint database (single-threaded)")
#     run_flow(
#         ads_language=None,  # include all languages
#         specific_ads=first_task.get("specific_ads")
#     )
#     print("✅ Fingerprint DB ready\n")
...
#     print(f"⚙️ Running detection with {max_workers} workers\n")
...
#                 print(
#                     f"✅ COMPLETED: {task['channel']} / {task['date']} "
#                     f"- {len(task_results)} segments"
#                 )

#             except Exception as exc:
#                 print(
#                     f"❌ FAILED TASK: {task['channel']} / {task['date']} "
#                     f"Exception: {exc}"
#                 )
...
#         df.sort_values(
#             by=["Channel", "Date", "Time", "Start Time"],
#             inplace=True
#         )
#         df.reset_index(drop=True, inplace=True)
#         df["Segment No"] = df.index + 1
...
#         print("\n" + "=" * 70)
#         print(f"🏆 SUCCESS: {len(ALL_RESULTS)} segments saved")
#         print(f"📄 {output_json_path}")
#         print("=" * 70)
